...
function Blogs() {
    ...
    async function getData() {
        const res = await fetch(
            "https://blogbackend3-0k42.onrender.com/getdata",
            {
                headers: {
    ...
    async function handleLike(e, id) {
        ...
        const res = await fetch(
            "https://blogbackend3-0k42.onrender.com/postlike",
            {
                method: "POST",
                body: json,
                headers: {
    ...
    async function handleSave(e, id) {
        ...
        const res = await fetch(
            "https://blogbackend3-0k42.onrender.com/postsave",
            {
                method: "POST",
                body: json,
                headers: {
    ...
    const publishComment = async (e, id) => {
        ...
        const res1 = await fetch("https://blogbackend3-0k42.onrender.com", {
            headers: {
                "Content-Type": "application/json",
                Accept: "application/json",
        ...
        const res = await fetch(
            "https://blogbackend3-0k42.onrender.com/postcomment",
            {
                method: "POST",
                body: json,
                headers: {
    ...
    const closeComment = async (idx) => {
        ...
        await fetch("https://blogbackend3-0k42.onrender.com/postcomment", {
            method: "POST",
            body: json,
            headers: {
                "Content-Type": "application/json",
    ...
    const deleteComment = async (e, blogId, commentId) => {
        ...
        const res = await fetch(
            `https://blogbackend3-0k42.onrender.com/api/blog/${blogId}/comment/${commentId}`,
            {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                            ...
                            {item.isChecked && (
                                <section className={"comment"}>
                                    ...
                                    <input
                                        type="text"
                                        onChange={(e) =>
                                            handleCommentChange(e, item._id)
                                        }
                                    />
                                    <button
                                        onClick={(e) =>
                                            publishComment(e, item._id)
                                        }
                                    >
                                        publish
                                    </button>
