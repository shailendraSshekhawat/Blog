...
function YourArticles() {
    ...
    async function getData() {
        ...
        const res = await fetch(
            "https://blogbackend3-0k42.onrender.com/yourblogs",
            {
                headers: {
                    "Content-Type": "application/json",
                    "x-access-token": token,
        ...
        if (res.ok) {
            ...
            const filteredBlogs = articles.filter(
                (blg) => blg.createdBy === name
            );
    ...
    const deleteBlog = async (e, id) => {
        ...
        const res = await fetch(
            `https://blogbackend3-0k42.onrender.com/deletearticles/${id}`,
            {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
